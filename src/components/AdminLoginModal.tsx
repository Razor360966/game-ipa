...
import { ShieldCheck, Lock, Eye, EyeOff, X, ArrowRight, KeyRound, Sparkles, Mail, Cloud } from 'lucide-react';
import { loginAdminWithSupabase, DEFAULT_ADMIN_EMAIL } from '../utils/auth';
    ...
    >
      <div className="bg-slate-900/95 border border-indigo-500/30 rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-[0_0_50px_rgba(79,70,229,0.3)] relative overflow-hidden text-slate-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Password Input */}
          <div className="space-y-1.5">
            <label htmlFor="input-admin-password" className="block text-xs font-bold text-slate-300 uppercase tracking-wider flex items-center justify-between">
              <span>Password Admin</span>
              <span className="text-[10px] text-indigo-400 font-normal">Default awal: 123456</span>
            </label>
